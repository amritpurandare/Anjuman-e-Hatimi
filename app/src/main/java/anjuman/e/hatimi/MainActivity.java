...
public class MainActivity extends AppCompatActivity {
    ...
    private static String mBaseUrl = "http://khandwa.technologyworkshops.net/index.php/app/mobileapp/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SharedPreferences sharedPreferences = getSharedPreferences("anjuman.e.hatimi", Context.MODE_PRIVATE);
